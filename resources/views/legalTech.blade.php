    ...
    <header class="header" id="header">
        <div class="nav-container">
            ...
            <nav class="nav-menu">
                ...
                <li class="nav-item"><a href="{{ route('legalTech') }}" class="nav-link active"><i class="fas fa-gavel"></i><span>Legal Tech</span></a></li>
            </nav>

            <div class="nav-cta">
                <a href="legalTech.html" class="btn btn-primary"> <i class="fas fa-gavel"></i>Legal Tech</a>
            </div>
...
<!-- Hero Section - Legal Tech Focused -->
...
">
    ...
    <div class="hero-container" style="max-width: 1400px; margin: 0 auto; display: grid; grid-template-columns: 1fr; gap: 2rem; text-align: center; position: relative; z-index: 2;">

        <!-- Legal Tech Introduction -->
        <div class="legal-tech-intro" style="max-width: 800px; margin: 0 auto;">
            <div style="display: inline-flex; align-items: center; gap: 0.5rem; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); padding: 0.75rem 1.5rem; border-radius: 50px; margin-bottom: 2rem; font-size: clamp(0.8rem, 2vw, 0.9rem); font-weight: 600; color: var(--primary-blue); box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1); border: 1px solid rgba(255, 255, 255, 0.2);">
                <span><i class="fas fa-robot"></i></span> Innovation Juridique
            </div>

            <h1 style="font-size: clamp(2rem, 5vw, 3.5rem); font-weight: 800; line-height: 1.1; margin-bottom: 1.5rem; color: var(--white); font-family: 'Playfair Display', serif; text-shadow: 0 4px 20px rgba(0, 0, 0, 0.3);">
                La <span style="background: linear-gradient(135deg, #FFD700, #FFA500); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-shadow: none;">Legal Tech</span> à Votre Service
            </h1>

            <p style="font-size: clamp(1rem, 2.5vw, 1.2rem); line-height: 1.6; color: rgba(255, 255, 255, 0.9); margin-bottom: 2rem; max-width: 600px; margin-left: auto; margin-right: auto; text-shadow: 0 2px 10px rgba(0, 0, 0, 0.2);">
                Découvrez notre plateforme innovante qui révolutionne l'accès au droit grâce à la technologie.
            </p>
        </div>
    </div>
</section>
...
<!-- Section Simulation Legal Tech -->
<section id="simulateur" class="legal-tech-simulator" style="
    padding: 5rem 1rem;
...
">
    <div class="container" style="max-width: 1200px; margin: 0 auto;">
        ...
        <!-- En-tête -->
        <div class="simulator-header" style="text-align: center; margin-bottom: 4rem;">
            <div style="display: inline-flex; align-items: center; gap: 0.5rem; background: var(--primary-blue); color: white; padding: 0.75rem 1.5rem; border-radius: 50px; margin-bottom: 1.5rem; font-size: 0.9rem; font-weight: 600;">
                <span><i class="fas fa-gavel"></i></span> Simulateur Juridique
            </div>
            ...
            <h2 style="font-size: clamp(2rem, 4vw, 3rem); font-weight: 700; color: var(--primary-blue); margin-bottom: 1rem; font-family: 'Playfair Display', serif;">
                Visualisez vos Documents Juridiques
            </h2>

            <p style="font-size: 1.1rem; color: var(--text-dark); max-width: 700px; margin: 0 auto; line-height: 1.6;">
                Notre simulateur vous permet de découvrir des exemples de documents juridiques que nous pouvons générer pour vous.
                <strong>Sélectionnez un type de document pour en visualiser un aperçu sécurisé.</strong>
            </p>
        </div>
        ...
        ">
            ...
            <div class="category-card" data-category="immobilier" style="
                background: white;
                border-radius: 15px;
                padding: 2rem;
                text-align: center;
            ...
            " onclick="selectCategory('immobilier')">
                <div style="width: 70px; height: 70px; background: #e3f2fd; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; font-size: 1.8rem; color: var(--primary-blue);">
                    <i class="fas fa-home"></i>
                </div>
                <h3 style="color: var(--primary-blue); margin-bottom: 1rem; font-size: 1.3rem;">Immobilier</h3>
                <p style="color: var(--text-dark); font-size: 0.95rem; line-height: 1.5;">
                    Contrats de location, baux, compromis de vente, et documents immobiliers.
                </p>
            </div>

            <!-- Catégorie Travail -->
            <div class="category-card" data-category="travail" style="
                background: white;
                border-radius: 15px;
                padding: 2rem;
                text-align: center;
                ...
                border: 2px solid transparent;
                box-shadow: 0 5px 20px rgba(0,0,0,0.08);
            " onclick="selectCategory('travail')">
                <div style="width: 70px; height: 70px; background: #f3e5f5; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; font-size: 1.8rem; color: #7b1fa2;">
                    <i class="fas fa-briefcase"></i>
                </div>
                <h3 style="color: #7b1fa2; margin-bottom: 1rem; font-size: 1.3rem;">Droit du Travail</h3>
                <p style="color: var(--text-dark); font-size: 0.95rem; line-height: 1.5;">
                    Contrats de travail, licenciement, rupture conventionnelle, et documents RH.
                </p>
            </div>

            <!-- Catégorie Entreprise -->
            <div class="category-card" data-category="entreprise" style="
                background: white;
                border-radius: 15px;
                padding: 2rem;
                text-align: center;
                ...
                border: 2px solid transparent;
                box-shadow: 0 5px 20px rgba(0,0,0,0.08);
            " onclick="selectCategory('entreprise')">
                <div style="width: 70px; height: 70px; background: #e8f5e8; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; font-size: 1.8rem; color: #2e7d32;">
                    <i class="fas fa-building"></i>
                </div>
                <h3 style="color: #2e7d32; margin-bottom: 1rem; font-size: 1.3rem;">Entreprise</h3>
                <p style="color: var(--text-dark); font-size: 0.95rem; line-height: 1.5;">
                    Statuts de société, contrats commerciaux, CGV, et documents d'entreprise.
                </p>
            </div>
        </div>

        <!-- Zone de visualisation du document (cachée au départ) -->
        <div id="document-viewer" style="display: none;">
            ...
            ">
                <div style="display: flex; justify-content: between; align-items: center; margin-bottom: 1rem;">
                    <h3 id="document-title" style="color: var(--primary-blue); margin: 0; font-size: 1.5rem;"></h3>
                    <span class="watermark" style="
                        background: #ffebee;
                        color: #c62828;
                        padding: 0.5rem 1rem;
                        border-radius: 20px;
                        font-size: 0.8rem;
                        font-weight: 600;
                    ">DOCUMENT DE DÉMONSTRATION</span>
                </div>
                <p id="document-description" style="color: var(--text-dark); margin: 0;"></p>
            </div>

            <!-- Conteneur du document sécurisé -->
            ...
            <!-- Call to Action -->
            <div class="document-cta" style="text-align: center; margin-top: 3rem;">
                <p style="color: var(--text-dark); margin-bottom: 1.5rem; font-size: 1.1rem;">
                    🔒 <strong>Ce document vous intéresse ?</strong> Contactez-nous pour obtenir la version complète personnalisée à vos besoins.
                </p>
                <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                    <button onclick="requestDocument()" style="
                        background: var(--primary-blue);
                        color: white;
                        border: none;
                        padding: 1rem 2rem;
                    ...
                    <button onclick="backToCategories()" style="
                        ...
                        transition: all 0.3s ease;
                    ">
                        <i class="fas fa-arrow-left"></i> Voir d'autres documents
                    </button>
                </div>
            </div>
        </div>
