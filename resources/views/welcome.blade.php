...
<body>
    ...
    <header class="header" id="header">
        <div class="nav-container">
            ...
            <nav class="nav-menu">
                <li class="nav-item"><a href="{{ route('welcome') }}" class="nav-link active"><i class="fas fa-home"></i><span>Accueil</span></a></li>
        ...
        <div class="mobile-menu" id="mobile-menu">
            <ul class="mobile-nav-menu">
                ...
                <li class="mobile-nav-item"><a href="{{ route('legalTech') }}" class="mobile-nav-link"> <i class="fas fa-gavel"></i>Legal Tech</a></li>
            </ul>
        </div>
    </header>
