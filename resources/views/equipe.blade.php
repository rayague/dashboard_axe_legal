...
<body>
    ...
    <header class="header" id="header">
        <div class="nav-container">
            ...
            <nav class="nav-menu">
                ...
                <li class="nav-item"><a href="{{ route('equipe') }}" class="nav-link active"><i class="fas fa-users"></i><span>Équipe</span></a></li>
    ...
    <section id="accueil" class="hero" style="
        background:
            ...
            url('{{ asset('front/assets/images/image2.jpg') }}') center/cover no-repeat;
        padding: 4rem 2rem;
        min-height: 85vh;
        display: flex;
        align-items: center;
    ...
    ">
        ...
        <div class="hero-container" style="max-width: 1400px; margin: 0 auto; display: grid; grid-template-columns: 1fr; gap: 3rem; text-align: center; position: relative; z-index: 2;">
            ...
            <!-- Team Introduction -->
            <div class="team-intro" style="max-width: 800px; margin: 0 auto;">
                <div style="display: inline-flex; align-items: center; gap: 0.5rem; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); padding: 0.75rem 1.5rem; border-radius: 50px; margin-bottom: 2rem; font-size: 0.9rem; font-weight: 600; color: var(--primary-blue); box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1); border: 1px solid rgba(255, 255, 255, 0.2);">
                    <span>🏛️</span> L'Excellence Juridique Incarnée
                </div>
                ...
                <h1 style="font-size: clamp(2.5rem, 5vw, 4rem); font-weight: 800; line-height: 1.1; margin-bottom: 1.5rem; color: var(--white); font-family: 'Playfair Display', serif; text-shadow: 0 4px 20px rgba(0, 0, 0, 0.3);">
                    L'Équipe qui <span style="background: linear-gradient(135deg, #FFD700, #FFA500); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-shadow: none;">Transforme</span> le Droit
                </h1>
                ...
                <p style="font-size: 1.2rem; line-height: 1.6; color: rgba(255, 255, 255, 0.9); margin-bottom: 3rem; max-width: 600px; margin-left: auto; margin-right: auto; text-shadow: 0 2px 10px rgba(0, 0, 0, 0.2);">
                    Quatre cellules d'expertise, une vision commune : révolutionner l'accompagnement juridique au Bénin avec innovation, passion et résultats.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="contact-form fade-in" id="consultation">
                ...
                <div class="whatsapp-questions">
                    ...
                    <a href="https://wa.me/2290197747593?text=Bonjour, je suis confronté à un redressement fiscal. Pouvez-vous m'assister ?" target="_blank" class="whatsapp-question">
                        <div class="question-icon"><i class="fas fa-scale-balanced"></i></div>
                        <div class="question-content">
