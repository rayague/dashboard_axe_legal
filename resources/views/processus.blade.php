...
<head>
    ...
    <link rel="manifest" href="vers/site.webmanifest">
    ...
    <meta property="og:image" content="https://www.axe-legal.bj/images/image8.png"><!-- Image optimisée 1200x630px -->
    ...
    <header class="header" id="header">
        <div class="nav-container">
            ...
            <nav class="nav-menu">
                ...
                <li class="nav-item"><a href="{{ route('processus') }}" class="nav-link active"><i class="fas fa-tasks"></i><span>Processus</span></a></li>
...
<section id="accueil" class="hero" style="
    background:
        ...
        url('{{ asset('front/assets/images/image3.jpg') }}') center/cover no-repeat;
    padding: 4rem 1rem;
    min-height: 85vh;
    display: flex;
    align-items: center;
...
">
    ...
    <div class="hero-container" style="max-width: 1400px; margin: 0 auto; display: grid; grid-template-columns: 1fr; gap: 3rem; text-align: center; position: relative; z-index: 2;">
        ...
        <div class="process-intro" style="max-width: 800px; margin: 0 auto;">
            ...
            <h1 style="font-size: clamp(2.5rem, 5vw, 4rem); font-weight: 800; line-height: 1.1; margin-bottom: 1.5rem; color: var(--white); font-family: 'Playfair Display', serif; text-shadow: 0 4px 20px rgba(0, 0, 0, 0.3);">
                Un <span style="background: linear-gradient(135deg, #FFD700, #FFA500); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-shadow: none;">Processus</span> d'Excellence
            </h1>
            ...
            <p style="font-size: clamp(1rem, 2.5vw, 1.2rem); line-height: 1.6; color: rgba(255, 255, 255, 0.9); margin-bottom: 3rem; max-width: 600px; margin-left: auto; margin-right: auto; text-shadow: 0 2px 10px rgba(0, 0, 0, 0.2);">
                Une approche structurée en 5 étapes pour garantir la qualité de nos prestations et la satisfaction de nos clients.
            </p>
        </div>
    </div>
</section>
...
<div class="process-steps-preview">
  ...
  <!-- Step 1 -->
  <div class="step-card" style="--badge-color: linear-gradient(135deg, #FF6B6B, #FF8E8E);">
    <div class="step-badge">1</div>
    <div class="step-icon"><i class="fas fa-user-check"></i></div>
    <h3 class="step-title">Analyse</h3>
    <p class="step-text">Écoute et analyse de vos besoins</p>
  </div>

  <!-- Step 2 -->
  <div class="step-card" style="--badge-color: linear-gradient(135deg, #4ECDC4, #44A08D);">
    <div class="step-badge">2</div>
    <div class="step-icon"><i class="fas fa-route"></i></div>
    <h3 class="step-title">Stratégie</h3>
    <p class="step-text">Élaboration d'une stratégie sur mesure</p>
  </div>

  <!-- Step 3 -->
  <div class="step-card" style="--badge-color: linear-gradient(135deg, #FFD93D, #FF6B6B);">
    <div class="step-badge">3</div>
    <div class="step-icon"><i class="fas fa-rocket"></i></div>
    <h3 class="step-title">Exécution</h3>
    <p class="step-text">Mise en œuvre rapide et efficace</p>
  </div>

  <!-- Step 4 -->
  <div class="step-card" style="--badge-color: linear-gradient(135deg, #667eea, #764ba2);">
    <div class="step-badge">4</div>
    <div class="step-icon"><i class="fas fa-sync-alt"></i></div>
    <h3 class="step-title">Suivi</h3>
    <p class="step-text">Contrôle et ajustements</p>
  </div>

  <!-- Step 5 -->
  <div class="step-card" style="--badge-color: linear-gradient(135deg, #11998e, #38ef7d);">
    <div class="step-badge">5</div>
    <div class="step-icon"><i class="fas fa-award"></i></div>
    <h3 class="step-title">Résultats</h3>
    <p class="step-text">Livraison et satisfaction client</p>
  </div>
        ...
        <div class="trust-container">
            ...
            <div class="trust-grid">
                <div class="trust-item fade-in">
                    ...
                    <div class="trust-label">Barreau du Bénin</div>
                    <div class="trust-desc">Inscrit et certifié</div>
                </div>
                <div class="trust-item fade-in">
