    ...
    <header class="header" id="header">
        <div class="nav-container">
            ...
            <nav class="nav-menu">
                ...
                <li class="nav-item"><a href="{{ route('contact') }}" class="nav-link active"><i class="fas fa-envelope"></i><span>Contact</span></a></li>
            </nav>
        ...
        <div class="hero-container" style="max-width: 1400px; margin: 0 auto; display: grid; grid-template-columns: 1fr; gap: 3rem; text-align: center; position: relative; z-index: 2;">
            ...
            <div class="contact-intro" style="max-width: 800px; margin: 0 auto;">
                <div style="display: inline-flex; align-items: center; gap: 0.5rem; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); padding: 0.75rem 1.5rem; border-radius: 50px; margin-bottom: 2rem; font-size: 0.9rem; font-weight: 600; color: var(--primary-blue); box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1); border: 1px solid rgba(255, 255, 255, 0.2);">
                    <span><i class="fas fa-phone"></i></span> Contactez-Nous
                </div>
                ...
                <p style="font-size: 1.2rem; line-height: 1.6; color: rgba(255, 255, 255, 0.9); margin-bottom: 3rem; max-width: 600px; margin-left: auto; margin-right: auto; text-shadow: 0 2px 10px rgba(0, 0, 0, 0.2);">
                    Prêt à discuter de vos besoins juridiques ? Notre équipe est à votre disposition pour vous accompagner.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="contact-items">
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        <h4>Adresse</h4>
                        <p>Godomey échangeur, en direction Calavi-Cotonou, <br> côté opposé à la mosquée.<br>Bénin</p>
                    </div>
                </div>
        ...
        <div class="contact-form fade-in" id="consultation">
            ...
            <div class="whatsapp-questions">
                <a href="https://wa.me/2290197747593?text=Bonjour, j'ai une question concernant l'optimisation fiscale de mon entreprise. Pouvez-vous m'aider ?" target="_blank" class="whatsapp-question">
                    <div class="question-icon"><i class="fas fa-piggy-bank" style="color: #004080;"></i></div>
                ...
                <a href="https://wa.me/2290197747593?text=Bonjour, j'ai besoin d'aide pour la création et structuration de ma société. Quelles sont les étapes ?" target="_blank" class="whatsapp-question">
                    <div class="question-icon"><i class="fas fa-building" style="color: #004080;"></i></div>
                    <div class="question-content">
                ...
                <a href="https://wa.me/2290197747593?text=Bonjour, je suis confronté à un redressement fiscal. Pouvez-vous m'assister ?" target="_blank" class="whatsapp-question">
                    <div class="question-icon"><i class="fas fa-scale-balanced" style="color: #004080;"></i></div>
                    <div class="question-content">
                ...
                <a href="https://wa.me/2290197747593?text=Bonjour, j'ai des créances impayées. Comment procéder au recouvrement ?" target="_blank" class="whatsapp-question">
                    <div class="question-icon"><i class="fas fa-file-invoice-dollar" style="color: #004080;"></i></div>
                    <div class="question-content">
                ...
                <a href="https://wa.me/2290197747593?text=Bonjour, j'ai un litige immobilier. Pouvez-vous m'aider à le résoudre ?" target="_blank" class="whatsapp-question">
                    <div class="question-icon"><i class="fas fa-house-chimney" style="color: #004080;"></i></div>
                    <div class="question-content">
                ...
                <a href="https://wa.me/2290197747593?text=Bonjour, je souhaite participer à un marché public. Pouvez-vous m'accompagner ?" target="_blank" class="whatsapp-question">
                    <div class="question-icon"><i class="fas fa-file-contract" style="color: #004080;"></i></div>
                    <div class="question-content">
