...
.mobile-menu {
        ...
        .carousel-icon {
            ...
            margin-bottom: 1rem;
            display: block;
            animation: carouselIconFloat 3s ease-in-out infinite;
            filter: drop-shadow(0 4px 8px rgba(30, 90, 168, 0.3));
            color: var(--primary-blue);
        }
    ...
    <header class="header" id="header">
        <div class="nav-container">
            <div class="logo-container">
                <img src="assets/images/image8.png" alt="Axe Legal Logo" class="logo-image">
            </div>

            <nav class="nav-menu">
                <li class="nav-item"><a href="index.html" class="nav-link active"><i class="fas fa-home"></i><span>Accueil</span></a></li>
                <li class="nav-item"><a href="services.html" class="nav-link"><i class="fas fa-gavel"></i><span>Services</span></a></li>
                <li class="nav-item"><a href="equipe.html" class="nav-link"><i class="fas fa-users"></i><span>Équipe</span></a></li>
                <li class="nav-item"><a href="processus.html" class="nav-link"><i class="fas fa-tasks"></i><span>Processus</span></a></li>
                <li class="nav-item"><a href="temoignage.html" class="nav-link"><i class="fas fa-comments"></i><span>Témoignages</span></a></li>
                <li class="nav-item"><a href="contact.html" class="nav-link"><i class="fas fa-envelope"></i><span>Contact</span></a></li>
            </nav>
        ...
        <div class="mobile-menu" id="mobile-menu">
            <ul class="mobile-nav-menu">
                <li class="mobile-nav-item"><a href="index.html" class="mobile-nav-link"><i class="fas fa-home"></i>Accueil</a></li>
                <li class="mobile-nav-item"><a href="services.html" class="mobile-nav-link"><i class="fas fa-gavel"></i>Services</a></li>
                <li class="mobile-nav-item"><a href="equipe.html" class="mobile-nav-link"><i class="fas fa-users"></i>Équipe</a></li>
                <li class="mobile-nav-item"><a href="processus.html" class="mobile-nav-link"><i class="fas fa-tasks"></i>Processus</a></li>
                <li class="mobile-nav-item"><a href="temoignage.html" class="mobile-nav-link"><i class="fas fa-comments"></i>Témoignages</a></li>
                <li class="mobile-nav-item"><a href="contact.html" class="mobile-nav-link"><i class="fas fa-envelope"></i>Contact</a></li>
                <li class="mobile-nav-item"><a href="consultation.html" class="mobile-nav-link"> <i class="fas fa-gavel"></i>Legal Tech</a></li>
            </ul>
        </div>
    </header>
                        ...
                        <div class="carousel-slides">
                            ...
                            <div class="carousel-slide active">
                                <div class="carousel-image">
                                    ...
                                    <div class="carousel-content">
                                        ...
                                        <p>Expertise en droit commercial et des sociétés</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-slide">
                                <div class="carousel-image">
                                    ...
                                    <div class="carousel-content">
                                        <h3>Fiscalité</h3>
                                        <p>Optimisation fiscale et conseil stratégique</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-slide">
                                <div class="carousel-image">
                                    ...
                                    <div class="carousel-content">
                                        ...
                                        <p>Transactions et conseils immobiliers sécurisés</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-slide">
                                <div class="carousel-image">
                                    ...
                                    <div class="carousel-content">
                                        ...
                                        <p>Support juridique sur-mesure pour votre entreprise</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-slide">
                                <div class="carousel-image">
                                    ...
                                    <div class="carousel-content">
                                        <h3>Notre Cabinet</h3>
                                        <p>Un cadre professionnel pour recevoir vos conseils juridiques</p>
                                    </div>
                                </div>
                            </div>
                        </div>
