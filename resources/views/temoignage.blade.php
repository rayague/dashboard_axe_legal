    ...
    <style>
        ...
        * {
        ...
        .parallax-background {
            ...
            height: 110%;
            background:
                linear-gradient(rgba(240, 253, 244, 0.9), rgba(240, 253, 244, 0.9)),
                url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><rect fill="%2338a169" fill-opacity="0.1" x="0" y="0" width="100" height="100"/><path d="M0 50 L100 50 M50 0 L50 100" stroke="%2338a169" stroke-width="1" stroke-opacity="0.2"/></svg>'),
                url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60"><circle cx="30" cy="30" r="5" fill="%2338a169" fill-opacity="0.2"/></svg>');
            background-size: cover, 100px 100px, 60px 60px;
        ...
        .parallax-foreground {
            ...
            width: 100%;
            height: 40%;
            background: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="%2338a169" fill-opacity="0.1" d="M0,128L48,117.3C96,107,192,85,288,112C384,139,480,213,576,218.7C672,224,768,160,864,128C960,96,1056,96,1152,117.3C1248,139,1344,181,1392,202.7L1440,224L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>') bottom no-repeat;
        ...
        /* Section de contenu pour démontrer l'effet parallax */
        /* Section de contenu pour démontrer l'effet parallax */
.content-section {
    padding: 4rem 1rem;
    max-width: 1200px;
...
@media (prefers-color-scheme: dark) {
    ...
    <script>
        ...
        window.addEventListener('scroll', function() {
            ...
            parallaxForeground.style.transform = `translateY(${scrollY * 0.2}px)`;
        });
        ...
        document.querySelectorAll('.stat-item, .testimonial-card').forEach(item => {
...
<body>
    ...
    <header class="header" id="header">
        <div class="nav-container">
            ...
            <nav class="nav-menu">
                ...
                <li class="nav-item"><a href="{{ route('temoignage') }}" class="nav-link active"><i class="fas fa-comments"></i><span>Témoignages</span></a></li>
    ...
    <section id="accueil" class="hero" style="
        background:
            ...
            url('{{ asset('front/assets/images/image5.jpg') }}') center/cover no-repeat;
        padding: 4rem 2rem;
        min-height: 85vh;
        display: flex;
        align-items: center;
    ...
    ">
        ...
        <div style="
            ...
            z-index: 1;
        "></div>
        <div class="hero-container" style="max-width: 1400px; margin: 0 auto; display: grid; grid-template-columns: 1fr; gap: 3rems; text-align: center; position: relative; z-index: 2;">

            <!-- Hero Introduction -->
            <div class="hero-intro" style="max-width: 800px; margin: 0 auto;">
                ...
                <h1 style="font-size: clamp(2.5rem, 5vw, 4rem); font-weight: 800; line-height: 1.1; margin-bottom: 1.5rem; color: var(--white); font-family: 'Playfair Display', serif; text-shadow: 0 4px 20px rgba(0, 0, 0, 0.3);">
                    La <span style="background: linear-gradient(135deg, #FFD700, #FFA500); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; text-shadow: none;">Confiance</span> de Nos Clients
                </h1>
                ...
                <p style="font-size: 1.2rem; line-height: 1.6; color: rgba(255, 255, 255, 0.9); margin-bottom: 3rem; max-width: 600px; margin-left: auto; margin-right: auto; text-shadow: 0 2px 10px rgba(0, 0, 0, 0.2);">
                    Découvrez les témoignages authentiques de nos clients qui nous font confiance pour leurs besoins juridiques.
                </p>
            </div>
        </div>
    </section>
<section class="content-section">
    <h2>Découvrez ce que disent nos clients</h2>
    <div class="testimonial-grid">
        <div class="testimonial-card">
            <div class="testimonial-icon">"</div>
            <p class="testimonial-text">"Le cabinet a résolu mon litige commercial avec professionnalisme et efficacité. Je recommande vivement leurs services."</p>
            <div class="testimonial-author">
                <span class="author-name">- Marie L., Entrepreneure</span>
                <span class="author-rating">★★★★★</span>
            </div>
        </div>
        <div class="testimonial-card">
            <div class="testimonial-icon">"</div>
            <p class="testimonial-text">"Un accompagnement personnalisé et des conseils avisés qui m'ont été d'une grande aide pour mon entreprise."</p>
            <div class="testimonial-author">
                <span class="author-name">- Thomas D., Chef d'entreprise</span>
                <span class="author-rating">★★★★★</span>
            </div>
        </div>
        <div class="testimonial-card">
            <div class="testimonial-icon">"</div>
            <p class="testimonial-text">"Expertise remarquable et un réel souci du client. J'ai été impressionné par la qualité du service fourni."</p>
            <div class="testimonial-author">
                <span class="author-name">- Sophie M., Directrice Juridique</span>
                <span class="author-rating">★★★★★</span>
            </div>
        </div>
    </div>
    ...
    <section id="temoignages" class="testimonials">
        <div class="testimonials-container">
            <div class="section-header fade-in">
                <div class="section-badge">  <i class="fas fa-comment-dots" style="color: #004080; margin-right: 6px;"></i>
 Témoignages</div>
            ...
            <div class="testimonials-grid">
                <div class="testimonial-card fade-in">
                    ...
                    <div class="testimonial-author">
                        ...
                        <div class="testimonial-info">
                            <h4>Marc KPONOU</h4>
                            <p>Directeur Général, TechBénin SARL</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial-card fade-in">
                    ...
                    <div class="testimonial-author">
                        ...
                        <div class="testimonial-info">
                            <h4>Sophie AGBODJAN</h4>
                            <p>DRH, Groupe Atlantique</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial-card fade-in">
                    ...
                    <div class="testimonial-author">
                        ...
                        <div class="testimonial-info">
                            <h4>Jean LOKOSSOU</h4>
                            <p>PDG, Industries du Bénin SA</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial-card fade-in">
                    ...
                    <div class="testimonial-author">
                        ...
                        <div class="testimonial-info">
                            <h4>Émilie ASSOGBA</h4>
                            <p>Promotrice Immobilière</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial-card fade-in">
                    ...
                    <div class="testimonial-author">
                        ...
                        <div class="testimonial-info">
                            <h4>Paul ADJANOHOUN</h4>
                            <p>Directeur, BTP Cotonou</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="testimonial-card fade-in">
                    ...
                    <div class="testimonial-author">
                        ...
                        <div class="testimonial-info">
                            <h4>Marie HOUNKANRIN</h4>
                            <p>Gérante, Commerce Plus</p>
                        </div>
                    </div>
                </div>
            </div>
